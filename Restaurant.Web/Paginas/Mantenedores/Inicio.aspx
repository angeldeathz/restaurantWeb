    ...
    <div class="row py-3 my-5 bg-blanco rounded">
        ...
        <div class="col-12 col-md-6">
            <ul class="list-group">
                ...
                <li class="list-group-item"><a runat="server" href="/Paginas/Mantenedores/GestionBodega.aspx" class="font-weight-bold">Gestión de Bodega</a>
                    <ul>
                ...
                <li class="list-group-item"><a runat="server" href="/Paginas/Mantenedores/GestionRestaurante.aspx" class="font-weight-bold">Gestión de Restaurante</a>
                    <ul>
                        <li><a runat="server" href="/Paginas/Mantenedores/GestionRestaurante.aspx">Reservas</a>
                ...
                <li class="list-group-item"><a runat="server" href="/Paginas/Mantenedores/GestionCocina.aspx" class="font-weight-bold">Gestión de Cocina</a>
                    <ul>
                ...
                <li class="list-group-item"><a runat="server" href="/Paginas/Mantenedores/GestionUsuarios.aspx" class="font-weight-bold">Gestión de Usuarios</a></li>
                <li class="list-group-item"><a runat="server" href="/Paginas/Mantenedores/Reporteria.aspx" class="font-weight-bold">Informes y Reportería</a></li>
            </ul>
        </div>
    </div>
</asp:Content>
